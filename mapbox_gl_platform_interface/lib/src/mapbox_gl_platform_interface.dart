...
abstract class MapboxGlPlatform {
  ...
  Future<String> addGeoLocatedCircle({int range, String id, double lat, double lng}) async {
    throw UnimplementedError('addGeoLocatedCircle() has not been implemented.');
  }
